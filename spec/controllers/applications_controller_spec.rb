  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved application as @application" do
        ...
        post :create, {:application => { "user" => "invalid value" }}, valid_session
        assigns(:application).should be_a_new(Application)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested application" do
        ...
        Application.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => application.to_param, :application => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the application as @application" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Application.any_instance.stub(:save).and_return(false)
        put :update, {:id => application.to_param, :application => { "user" => "invalid value" }}, valid_session
        assigns(:application).should eq(application)
      end
